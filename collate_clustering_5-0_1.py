...
dataset_name = "Wit-Fig4-5-0_1"
defects_numbers = [0, 1, 2, 3] # list of all
knees_alg = [6, 5, 8, 7] # algorithmic knees for corresponding defects
knees_man = [0, 4, 0, 5] # manual knees based on SS consideration as well - ignored if 0
